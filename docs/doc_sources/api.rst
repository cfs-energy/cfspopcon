...
Configuration Enums
=====================
.. automodule:: cfspopcon.named_options
...
The functions and classes below are listed here for completeness.
But these are internals, so it should usually not be required to interact with any of them directly.
