...
from ...algorithm_class import CompositeAlgorithm, declare_algorithm
from ...unit_handling import Unitfull, ureg, wraps_ufunc
from .read_energy_confinement_scalings import _get_confinement_scaling


@declare_algorithm(return_keys=["energy_confinement_time"])
@wraps_ufunc(
...
@declare_algorithm(return_keys=["H98y2"])
def calc_H98y2(
