...
@declare_algorithm(return_keys=["greenwald_fraction"])
...
@declare_algorithm(return_keys=["greenwald_density_limit"])
...
@declare_algorithm(return_keys=["average_electron_density"])
