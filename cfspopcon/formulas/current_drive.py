...
@Algorithm.register_algorithm(
    return_keys=["spitzer_resistivity", "trapped_particle_fraction", "neoclassical_loop_resistivity", "loop_voltage", "P_ohmic"]
)
def calc_resistive_heating(
    ...
    spitzer_resistivity = calc_Spitzer_loop_resistivity(average_electron_temp)
    trapped_particle_fraction = calc_resistivity_trapped_enhancement(inverse_aspect_ratio)
    neoclassical_loop_resistivity = calc_neoclassical_loop_resistivity(spitzer_resistivity, z_effective, trapped_particle_fraction)
    loop_voltage = calc_loop_voltage(major_radius, minor_radius, inductive_plasma_current, areal_elongation, neoclassical_loop_resistivity)
    P_ohmic = calc_ohmic_power(inductive_plasma_current, loop_voltage)
