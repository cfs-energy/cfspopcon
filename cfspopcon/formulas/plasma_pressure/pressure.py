...
def calc_average_total_pressure(
    average_electron_density: Unitfull, average_electron_temp: Unitfull, average_ion_density: Unitfull, average_ion_temp: Unitfull
) -> Unitfull:
    """Calculate the average total pressure."""
    return average_electron_density * average_electron_temp + average_ion_density * average_ion_temp
