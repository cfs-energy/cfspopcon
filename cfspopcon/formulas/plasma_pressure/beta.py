...
@declare_algorithm(return_keys=["beta_toroidal"])
...
@declare_algorithm(return_keys=["beta_poloidal"])
...
@declare_algorithm(return_keys=["beta_total"])
...
@declare_algorithm(return_keys=["normalized_beta"])
...
@declare_algorithm(return_keys=["troyon_max_beta"])
@wraps_ufunc(
