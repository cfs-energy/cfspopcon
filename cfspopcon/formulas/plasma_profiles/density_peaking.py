...
@declare_algorithm(return_keys=["ion_density_peaking", "peak_fuel_ion_density"])
...
@declare_algorithm(return_keys=["electron_density_peaking", "peak_electron_density"])
...
@declare_algorithm(return_keys=["effective_collisionality"])
@wraps_ufunc(
