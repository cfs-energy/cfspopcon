...
@declare_algorithm(return_keys=["B_pol_out_mid"])
@wraps_ufunc(
...
@declare_algorithm(return_keys=["B_t_out_mid"])
...
@declare_algorithm(return_keys=["fieldline_pitch_at_omp"])
...
@declare_algorithm(return_keys=["q_parallel"])
...
@declare_algorithm(return_keys=["q_perp"])
