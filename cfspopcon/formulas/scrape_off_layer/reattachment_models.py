...
@declare_algorithm(return_keys=["target_neutral_pressure", "pumping_duct_neutral_pressure"])
...
@declare_algorithm(return_keys=["reattachment_time"])
...
@declare_algorithm(return_keys=["ionization_volume"])
...
@declare_algorithm(return_keys=["neutral_flux_density_factor"])
