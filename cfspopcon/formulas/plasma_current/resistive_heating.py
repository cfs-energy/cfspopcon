...
@declare_algorithm(return_keys=["P_ohmic"])
...
@declare_algorithm(return_keys=["spitzer_resistivity"])
...
@declare_algorithm(return_keys=["trapped_particle_fraction"])
...
@declare_algorithm(return_keys=["neoclassical_loop_resistivity"])
...
@declare_algorithm(return_keys=["current_relaxation_time"])
@wraps_ufunc(
    input_units=dict(
        major_radius=ureg.m,
...
@declare_algorithm(return_keys=["loop_voltage"])
