...
from ....algorithm_class import declare_algorithm
...
@declare_algorithm(return_keys=["internal_inductivity"])
...
@declare_algorithm(return_keys=["internal_inductance"])
...
@declare_algorithm(return_keys=["external_inductance"])
...
@declare_algorithm(return_keys=["vertical_field_mutual_inductance"])
...
@declare_algorithm(return_keys=["invmu_0_dLedR"])
...
@declare_algorithm(return_keys=["vertical_magnetic_field"])
