...
@declare_algorithm(return_keys=["internal_flux"])
...
@declare_algorithm(return_keys=["external_flux"])
...
@declare_algorithm(return_keys=["resistive_flux"])
...
@declare_algorithm(return_keys=["poloidal_field_flux"])
...
@declare_algorithm(return_keys=["flux_needed_from_CS_over_rampup"])
...
@declare_algorithm(return_keys=["max_flattop_duration"])
...
@declare_algorithm(return_keys=["breakdown_flux_consumption"])
