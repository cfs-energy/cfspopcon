...
@algorithm(return_keys=["internal_flux"])
...
@algorithm(return_keys=["external_flux"])
...
@algorithm(return_keys=["resistive_flux"])
...
@algorithm(return_keys=["poloidal_field_flux"])
...
@algorithm(return_keys=["flux_needed_from_CS_over_rampup"])
...
@algorithm(return_keys=["max_flattop_duration"])
...
@algorithm(return_keys=["breakdown_flux_consumption"])
